...
import { habilitadosPorEdificio, obtenerEdificioPorCodigo } from '../../../Context/Edificios';
import LoadingSkeleton from '../../LoadingSkeleton';
import ResidentesListadoPage from '../../Persona/Residente/Listado';

const HabilitadosPage = () => {
  ...
  const fetchHabitantes = async (codigo) => {
    setLoading(true);
    try {
      const habitantesData = await habilitadosPorEdificio(codigo);
...
export default HabilitadosPage;
