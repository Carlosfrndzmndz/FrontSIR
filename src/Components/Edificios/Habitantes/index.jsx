...
import { habitantesPorEdificio, obtenerEdificioPorCodigo } from '../../../Context/Edificios';
import LoadingSkeleton from '../../LoadingSkeleton';
import ResidentesListadoPage from '../../Persona/Residente/Listado';

const HabitantesPage = () => {
  ...
  const fetchHabitantes = async (codigo) => {
    setLoading(true);
    try {
      const habitantesData = await habitantesPorEdificio(codigo);
